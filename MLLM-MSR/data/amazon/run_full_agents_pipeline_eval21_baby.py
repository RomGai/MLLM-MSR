...
def build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--item-desc-tsv", default="./processed/Baby_Products_item_desc.tsv") 
    parser.add_argument("--user-pairs-tsv", default="./processed/Baby_Products_u_i_pairs.tsv")
    parser.add_argument("--eval-user-items-negs-tsv", default="./processed/Baby_Products_user_items_negs_test.csv")
    parser.add_argument("--agent2-user-items-negs-tsv", default="./processed/Baby_Products_user_items_negs.tsv")
    parser.add_argument(
